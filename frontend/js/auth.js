...
async function registerUser() {
  ...
  try {
    ...
    showError("reg-error", "Cannot connect to server! Make sure the backend is running at http://127.0.0.1:5000");
  } finally {
...
async function loginUser() {
  ...
  try {
    ...
    showError("login-error", "Cannot connect to server! Make sure the backend is running at http://127.0.0.1:5000");
  } finally {
